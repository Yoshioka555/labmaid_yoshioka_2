...
class MainTextPageDemo extends StatefulWidget {
  final MemoData memo;
  const MainTextPageDemo({Key? key, required this.memo}) : super(key: key);

  @override
  _MainTextPageDemoState createState() => _MainTextPageDemoState();
}

class _MainTextPageDemoState extends State<MainTextPageDemo> {
